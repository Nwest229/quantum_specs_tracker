...
def F(
    value: Any = UNKNOWN, source: str = "", retrieved: str = "", method: str = "", kind: str = ""
) -> Field:
...
_GROUPS: dict[str, tuple[str, ...] | None] = {
...
_SCALAR_META = ("id", "type", "model", "system_name", "planned_release", "commercial_release")
...
class BackendRecord:
    ...
    def _emit_source(self, sources: list[dict[str, Any]], path: str, fld: Field | None) -> None:
